...
<div class="login-box">
  <div class="login-logo">
    <a href="/"><b>Check Out Mengajar</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">
        <?php if ($this->session->flashdata('message')!==""){
                echo "<font color='red'>".$this->session->flashdata('message')."</font>";
            }
        ?>          
      </p>
      
      <form action="<?=base_url()?>ajar/checkout" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" maxlength="18" class="form-control" placeholder="NIP" required>
